...
const Key = tw.div`font-medium text-brown-400`;

const PrimaryButton = tw(PrimaryButtonBase)`mt-8 md:mt-10 text-sm inline-block mx-auto md:mx-0`;

const DecoratorBlob = styled(SvgDotPattern)(props => [
  tw`w-20 h-20 absolute right-0 bottom-0 transform translate-x-1/2 translate-y-1/2 fill-current text-brown-300 -z-10`
]);
...
export default ({
  ...
  description = "The success of an orgaisation depends on the feedback and reputation it has formed in the minds of the customers. We introduce ourselves as a quality centric organization engaged in manufacturing",
